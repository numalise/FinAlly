...
// Generate distinct colors for each asset using the same algorithm as the main pie chart
const generateAssetColors = (count: number): string[] => {
  return Array.from({ length: count }, (_, i) => getColorForIndex(i));
};
...
export default function CategoryDetailModal({ isOpen, onClose, category, onUpdateTarget }: CategoryDetailModalProps) {
  ...
  const colors = generateAssetColors(category.assets.length);
                  ...
                  <Table variant="simple" size="sm">
                    <Thead>
                      <Tr>
                        ...
                        <Th border="none" isNumeric>Market Cap</Th>
